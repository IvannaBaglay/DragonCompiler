...
typedef enum tag
{
	AND = 256, BASIC, BREAK, DO, ELSE, THEN,ENDIF, EQ, FALSE, GE, IF, ID,
	INDEX, LE, MINUS, NE, NUM, OR, REAL, TEMP, TRUE, WHILE, ENDWHILE,
	PROGRAM, PROCEDURE, BEGIN, END,
	TAG_NULL,
	INTEGER, FLOAT, BLOCKFLOAT,EXT,COMPLEX, SIGNAL,
} Tag;
